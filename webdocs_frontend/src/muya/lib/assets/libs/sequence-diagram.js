...
var parser = (function () {
  ...
  var o = function (k, v, o, l) {
    ...
    return o
  }; var $V0 = [5, 8, 9, 13, 15, 24]; var $V1 = [1, 13]; var $V2 = [1, 17]; var $V3 = [24, 29, 30]; var parser = {
    trace: function () {},
    yy: {},
    symbols_: {
      error: 2,
    ...
    parse: function (input) {
      ...
      var self = this; var stack = [0]; var vstack = [null]; var lstack = []; var table = this.table; var yytext = ''; var yylineno = 0; var yyleng = 0; var recovering = 0; var TERROR = 2; var EOF = 1; var args = lstack.slice.call(arguments, 1); var lexer = Object.create(this.lexer); var sharedState = {
        yy: {}
      }
      ...
      for (var symbol, preErrorSymbol, state, action, r, p, len, newState, expected, yyval = {}; ;) {
        if (state = stack[stack.length - 1], this.defaultActions[state] ? action = this.defaultActions[state] : (symbol !== null && typeof symbol !== 'undefined' || (symbol = lex()),
    ...
    var lexer = {
      ...
      showPosition: function () {
        var pre = this.pastInput(); var c = new Array(pre.length + 1).join('-')
